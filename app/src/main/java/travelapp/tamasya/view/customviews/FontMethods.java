package travelapp.tamasya.view.customviews;
...
public class FontMethods {
    ...
    public static void setTypeface(Context context, EditText editText, String fontname) {
        editText.setTypeface(getTypeface(context, fontname));
    }
}